...
export const metadata = {
  ...
  description: "Introduce a family or school that may value Stable Future's careers advice.",
          ...
          <div className="flex flex-col gap-8 text-center">
            <header className="flex flex-col gap-4">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight text-ink sm:text-5xl">
                Know a family or school we could help?
              </h1>
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row">
              <Button href={familyEmail} size="lg">
                I know a family
              </Button>
              <Button href={schoolEmail} size="lg" variant="secondary">
                I know a school
              </Button>
            </div>
