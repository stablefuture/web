...
export function Checker() {
  ...
  return (
    <div className="flex flex-col gap-6 lg:grid lg:grid-cols-[40rem_minmax(0,1fr)] lg:items-start lg:gap-x-8">
      ...
      <div className="flex flex-col gap-4">
        <div ref={resultRef} className="grid items-stretch scroll-mt-16 gap-6 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-[minmax(0,1.25fr)_minmax(0,0.75fr)]">
          <Card unit={selected} prev={prev} onBack={back} onClear={clear} />
          <div className="flex h-full items-center justify-center rounded-2xl border border-border-soft p-3">
...
function Card({
  ...
  return (
    <div className="flex h-full min-w-0 flex-col justify-between gap-3 rounded-2xl border border-border-soft p-3 sm:p-4">
