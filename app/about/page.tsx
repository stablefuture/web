import { FounderBio } from "@/app/components/FounderBio";
      ...
      <Section as="section" tight>
        <Container narrow>
          <div className="flex flex-col gap-12">
            <header><p className="mb-3 text-xs uppercase tracking-widest text-muted">About Stable Future</p><h1 className="text-4xl sm:text-5xl">The people and thinking behind the advice.</h1></header>
            <FounderBio />
